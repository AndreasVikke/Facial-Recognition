...
ap.add_argument("-t", "--training", required=True, help="path to input training XML")
ap.add_argument("-m", "--model", required=True, help="path to serialized dlib shape predictor")
